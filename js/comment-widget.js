...
const s_maxLength = 75; // The max character length of a comment
...
const v_formHtml = `
    ...
    <div id="c_textWrapper" class="c-inputWrapper">
        ...
        <textarea class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50" maxlength="${s_maxLength}" required style="resize: none;"></textarea>
    </div>
